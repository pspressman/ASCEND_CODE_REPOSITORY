...
# ============================================================================
# CONFIGURATION - BATCH 1 (CSA)
# ============================================================================

# Input CSV from LLMAnon (same for both batches)
LLMANON_CSV_PATH = r"C:\path\to\data\LLMAnon\LLM-Anon-reviewed.csv"

# Search directories - BATCH 1: CSA WordStamps
JSON_SEARCH_DIRS = [
    r"C:\path\to\data\ASCEND_PHI\DeID\CSA_WordStamps",
]
...
# Output directory - BATCH 1
OUTPUT_DIR = r"C:\path\to\data\LLMAnon\Batch1_CSA_Timestamps"
OUTPUT_CSV = os.path.join(OUTPUT_DIR, "phi_timestamps_Batch1_CSA.csv")
LOG_FILE = os.path.join(OUTPUT_DIR, f"bridge_Batch1_CSA_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
TEXT_NOT_FOUND_LOG = os.path.join(OUTPUT_DIR, "text_not_found_Batch1.txt")
CLINIDEID_MARKERS_LOG = os.path.join(OUTPUT_DIR, "clinideid_markers_skipped_Batch1.txt")
MISSING_FILES_LOG = os.path.join(OUTPUT_DIR, "missing_files_Batch1.txt")
