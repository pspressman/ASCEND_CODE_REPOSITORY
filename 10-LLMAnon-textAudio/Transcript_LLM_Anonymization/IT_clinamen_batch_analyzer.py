...
3. CALCULATE COMBINED POPULATION:
   - Multiply probabilities: teacher (3M) × 35 years (0.2%) × small town (0.1%) = 600 people ⚠️
...
"""
    ...
    def get_processed_files(self, output_dir):
        """Get list of already processed files"""
        tracker_file = Path(output_dir) / '.processed_files.txt'
