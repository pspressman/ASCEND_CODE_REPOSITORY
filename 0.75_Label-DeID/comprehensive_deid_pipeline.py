...
source_dir = "/path/to/volumes/video_research/ASCEND_PROCESSING/Audio"
output_dir = "Output: /path/to/volumes/Databackup2025/DELIVERY/ASCEND_AP_Label_DeID"
    ...
    for root, dirs, files in os.walk(source_dir):
        ...
        for filename in files:
            ...
            if stats['total_files'] % 100 == 0:
                print(f"Processed {stats['total_files']} files...", end='\r')
